...
final class NodeCheckAlt1ConfigTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var array
     */
    private $testData = [
        ...
        [
            ...
            [
                'parent'    => ['type' => 'attribute', 'name' => 'class', 'value' => 'special',],
        ...
        [
            ...
            'parents'  => [
                'tags'       => ['ol', 'ul'],
                'attributes' => [['name' => 'class', 'value' => 'key'],],
            ],
            'children' => [
                'tags'       => ['li'],
    ...
    private $samples = [
        ...
        8  => '<table class="special"><caption>Words</caption><tr><td>test</td><td>test</td></tr></table>',
        ...
        13 => '<h6 class="pull">Test side one</h6><div class="key">test side two</div><div class="h">test side 3</div>',
        14 => '<table>
                   <thead>
    ...
    public function testGetType()
    {
        ...
        $this->assertEquals('special', $this->manager->getType($this->docs[10]->firstChild));
        $this->assertEquals('special', $this->manager->getType($this->docs[13]->firstChild));
        $this->assertEquals('split', $this->manager->getType($this->docs[15]->firstChild));
        $this->assertEquals('recursive', $this->manager->getType($this->docs[13]->childNodes->item(1)));
    ...
    public function testIsSpecialNode()
    {
        ...
        $this->assertFalse($this->manager->isSpecialNode($this->docs[11]->childNodes->item(0)));
        $this->assertFalse($this->manager->isSpecialNode($this->docs[11]->childNodes->item(1)));
    }
    ...
    public function testIsRecursiveParentNode()
    {
        ...
        $this->assertFalse($this->manager->isRecursiveParentNode($this->docs[16]->firstChild));
        $this->assertFalse($this->manager->isRecursiveParentNode($this->docs[17]->firstChild));
        $this->assertTrue($this->manager->isRecursiveParentNode($this->docs[13]->childNodes->item(1)));
    }
